...
export const chatDefaultOptions: ChatComponentOptions = {
  ...
  promptSuggestions: [
    'I have a sore throat and fever. What could it be?',
  ...
  messages: [],
  strings: {
    promptSuggestionsTitle: 'Ask about symptoms, diseases, or treatments',
    citationsTitle: 'Citations:',
    followUpQuestionsTitle: 'Follow-up questions:',
    chatInputPlaceholder: 'Describe your symptoms or ask about a disease...',
